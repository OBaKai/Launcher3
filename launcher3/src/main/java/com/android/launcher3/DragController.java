...
/**
 * DragLayer只是一个ViewGroup，
 * 具体的拖拽的处理都放到了DragController中。
 */
public class DragController {
    ...
    public DragView startDrag(Bitmap b, int dragLayerX, int dragLayerY,
        ...
        //DragView对象添加到你手放置的位置，此时可以知道你拖拽的原来是DragView对象
    ...
    private void handleMoveEvent(int x, int y) {
        ...
        //DropTarget是你拖动你的View要放入的地方
        //这里通过findDropTarget寻找相对应的DropTarget
