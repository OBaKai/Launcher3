...
class SimpleBitmapRegionDecoderWrapper implements SimpleBitmapRegionDecoder {
    ...
    public static SimpleBitmapRegionDecoderWrapper newInstance(
        ...
        try {
            ...
            Log.w("BitmapRegionTileSource", "getting decoder failed for path " + pathName + ", exception: " + e);
            return null;
        }
        return null;
    }
    public static SimpleBitmapRegionDecoderWrapper newInstance(
        ...
        try {
            ...
            Log.w("BitmapRegionTileSource", "getting decoder failed" + ", exception: " + e);
            return null;
        }
        return null;
    }
        ...
        public boolean loadInBackground(InBitmapProvider bitmapProvider) {
            ...
            if (mDecoder == null) {
                ...
                if (bitmapProvider != null) {
                    ...
                    if (reusableBitmap != null) {
                        ...
                        try {
                            ...
                            Log.d(TAG, "Unable to reusage bitmap" + ", exception: " + e);
                            opts.inBitmap = null;
                            mPreview = null;
                        }
                    }
                ...
                try {
                    ...
                    Log.d(TAG, "Image cannot be rendered on a GL surface" + ", exception: " + e);
                    mState = State.ERROR_LOADING;
                }
                return true;
            }
    ...
    public static class FilePathBitmapSource extends BitmapSource {
        ...
        public boolean readExif(ExifInterface ei) {
            try {
                ...
                Log.w("BitmapRegionTileSource", "reading exif failed" + ", exception: " + e);
                return false;
            } catch (IOException e) {
                Log.w("BitmapRegionTileSource", "getting decoder failed" + ", exception: " + e);
                return false;
    ...
    public static class UriBitmapSource extends BitmapSource {
        ...
        public boolean readExif(ExifInterface ei) {
            ...
            try {
                ...
                Log.d("BitmapRegionTileSource", "Failed to load URI " + mUri + ", exception: " + e);
                return false;
            } catch (IOException e) {
                Log.d("BitmapRegionTileSource", "Failed to load URI " + mUri + ", exception: " + e);
                return false;
            } catch (NullPointerException e) {
                Log.d("BitmapRegionTileSource", "Failed to read EXIF for URI " + mUri + ", exception: " + e);
                return false;
            } finally {
                Utils.closeSilently(is);
            }
